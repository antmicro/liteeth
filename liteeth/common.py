...
rtp_jpeg_header = Header(rtp_jpeg_header_fields+rtp_header_fields,
...
rtp_raw_header_fields = {
    ...
    "field":         HeaderField(rtp_header_length+4, 15, 1),
    "line_no":       HeaderField(rtp_header_length+4, 0,  15),
    "cont":          HeaderField(rtp_header_length+6, 15, 1),
    "offset":        HeaderField(rtp_header_length+6, 0,  15),
}

rtp_raw_header = Header(rtp_raw_header_fields+rtp_header_fields,
